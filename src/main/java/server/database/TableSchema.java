...
/**
 * Classe TableSchema crea lo schema di una tabella del database.
 */
public class TableSchema {
	...
	/**
	 * Costruttore della classe TableSchema che inizializza l'attributo db.
	 * @param db connessione al database.
	 * @param tableName nome della tabella.
	 * @throws SQLException in caso di errore nella interrogazione al database.
